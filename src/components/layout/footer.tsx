      ...
      <div className="container mx-auto px-4 py-2.5">
        <div className="mb-2 flex flex-wrap items-center justify-between gap-2 border-b border-white/10 pb-2">
          <div><div className="text-[9px] font-black uppercase tracking-[.28em] text-cyan-300">Global gaming community</div><div className="mt-0.5 text-lg font-black tracking-tight">GYOPO NETWORK</div></div>
           <div className="flex gap-1.5 text-[9px] font-black"><Link href="/regions" className="rounded-full border border-cyan-300/20 bg-cyan-300/10 px-2.5 py-1.5 text-cyan-200">REGIONS</Link><Link href="/community" className="rounded-full border border-white/10 bg-white/5 px-2.5 py-1.5 text-slate-300">COMMUNITY</Link><Link href="/apps" className="rounded-full border border-violet-300/20 bg-violet-300/10 px-2.5 py-1.5 text-violet-200">APPS</Link></div>
        </div>

      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
          <div className="col-span-1 md:col-span-2">
            <h3 className="mb-2 text-base font-black">PLAY · CONNECT · BELONG</h3>
            <p className="max-w-md text-sm leading-6 text-slate-500">
              전 세계 한인이 게임, 라이브 채팅, 음악과 지역 정보를 함께 나누는 글로벌 커뮤니티입니다.
            </p>
          </div>
          <div>
             <h4 className="mb-2 text-xs font-black uppercase tracking-[.2em] text-slate-300">Network</h4>
          ...
          <div>
             <h4 className="mb-2 text-xs font-black uppercase tracking-[.2em] text-slate-300">Support</h4>
            <ul className="space-y-2 text-sm text-slate-500">

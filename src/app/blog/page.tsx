...
const articles = [
  ...
  { category: '금융', title: '해외 생활비를 안전하게 관리하는 기본 원칙', date: '2026-08-20', body: '결제 수단 확인, 이체 기록, 수수료 확인, 승인 기록을 한 번에 관리하는 방법을 정리했습니다.' },
  ...
  { category: '테크', title: '교민 포털에서 개인정보를 지키는 브라우저 습관', date: '2026-08-16', body: '공용 기기 로그아웃, 개인정보 보호, 링크 확인, 영상 통화 권한을 안전하게 관리하는 법입니다.' },
];
...
export default function BlogPage() {
  ...
  return (
    <div className="category-page mx-auto max-w-6xl px-4 py-8">
      <header className="category-header text-white"><div className="category-heading">

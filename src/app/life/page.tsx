...
export default function LifePage() {
  return (
    <div className="category-page mx-auto max-w-7xl px-4 py-8 text-slate-100 sm:px-6 lg:px-8">
      <header className="category-header"><div className="category-heading"><p className="text-xs font-black uppercase tracking-[.22em] text-emerald-300">Everyday essentials / 생활</p><h1 className="mt-3 text-4xl font-black tracking-tight text-white sm:text-5xl">해외 생활을 더 가볍게</h1><p className="mt-4 text-sm leading-7 text-slate-300">살 곳을 찾고, 일할 곳을 찾고, 믿을 만한 업소와 필요한 정보를 찾는 일까지. 지역을 중심으로 교민 생활의 다음 행동을 연결합니다.</p></div></header>

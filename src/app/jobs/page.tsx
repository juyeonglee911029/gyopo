...
import { fetchSourceCategory, isGenuineJobListing, normalizeSourceText, normalizeSourceTitle } from '@/lib/sourcepreview';
    ...
    <div className="category-page jobs-page min-h-screen bg-transparent px-4 py-8 text-white">
      <div className="category-shell mx-auto max-w-5xl">
        ...
        <main className="space-y-4">
           ...
           {!isLoading && !(filters.saved && favoriteKey && !favoritesReady) && filteredJobs.length === 0 && <div className="rounded-xl border border-dashed border-white/15 py-12 text-center"><p className="text-slate-400">선택한 조건에 맞는 공고가 없습니다. 조건을 해제하거나 전체를 선택해주세요.</p></div>}

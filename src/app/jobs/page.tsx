     ...
     <div className="jobs-page min-h-screen bg-transparent px-4 py-8 text-white">
      ...
      <div className="mb-8"><BannerAd type="horizontal" /></div>
       <div className="flex flex-col gap-8 md:flex-row">
         <aside className="w-full shrink-0 md:w-64"><div className="rounded-xl border border-white/10 bg-white/[.045] p-5"><h3 className="mb-4 border-b border-white/10 pb-2 text-lg font-bold text-white">안내</h3><p className="text-sm leading-6 text-slate-300">실제 구인 정보만 등록해주세요. 국가 선택 없이 전체 공고를 국가 태그로 구분해 보여드립니다.</p></div><div className="mt-6"><BannerAd type="vertical" /></div></aside>
        <main className="flex-1 space-y-4">
           {filteredJobs.length === 0 && <div className="rounded-xl border border-dashed border-white/15 py-20 text-center"><span className="mb-4 block text-4xl">📭</span><p className="text-slate-500">해당 국가의 구인/구직 공고가 없습니다.</p></div>}

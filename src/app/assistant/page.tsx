...
export default function AssistantPage() {
  ...
  return (
    <div className="assistant-page min-h-[calc(100vh-64px)] bg-transparent px-4 py-8 text-white backdrop-blur-xl sm:px-6 lg:px-10">
       <div className="mx-auto flex min-h-[calc(100vh-128px)] w-full max-w-6xl flex-col overflow-hidden rounded-[2rem] border border-white/15 bg-[#10182b]/60 shadow-2xl backdrop-blur-2xl">

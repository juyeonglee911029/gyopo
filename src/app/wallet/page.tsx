      ...
      <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-3xl p-8 text-white mb-8 shadow-xl">
        ...
        <div>
         ...
         <div className="text-right">
          ...
          <p className="mt-6 rounded-xl border border-amber-300/20 bg-amber-300/10 px-4 py-3 text-xs leading-5 text-amber-100">서비스 잔액은 사이트 내부 원장이고, 실제 체인 잔액은 TRON 블록체인 조회값입니다. 주소는 잠금된 프로필 정보로만 표시됩니다. 개인키 보관 서버가 준비되기 전에는 자동 Wallet 생성과 실제 송금을 활성화하지 않습니다.</p>
      </div>
